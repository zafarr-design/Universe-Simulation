...
/* Section: FANN Training
        ...
        Two fundamentally different approaches are the most commonly used:
                ...
                Fixed topology training - The size and topology of the ANN is determined in advance
                        and the training alters the weights in order to minimize the difference
   between the desired output values and the actual output values. This kind of training is
                        supported by <fann_train_on_data>.

                Evolving topology training - The training start out with an empty ANN, only
   consisting of input and output neurons. Hidden neurons and connections are added during training,
                        in order to reach the same goal as for fixed topology training. This kind of
   training is supported by <FANN Cascade Training>.
 */
...
/* Struct: struct fann_train_data
        ...
        The training data structure is very usefull for storing data during training and testing of
   a neural network.
...
/* Function: fann_train_on_data
   ...
   stdout. A value of zero means no reports should be printed. desired_error - The desired
   <fann_get_MSE> or <fann_get_bit_fail>, depending on which stop function is chosen by
...
*/
FANN_EXTERNAL struct fann_train_data *FANN_API fann_create_train(unsigned int num_data,
                                                                 unsigned int num_input,
                                                                 unsigned int num_output);
...
*/
FANN_EXTERNAL struct fann_train_data *FANN_API
...
/* Function: fann_create_train_array
   Creates an training data struct and fills it with data from provided arrays, where the arrays
   ...
   See also:
    ...
    This function appears in FANN >= 2.3.0
*/
FANN_EXTERNAL struct fann_train_data *FANN_API fann_create_train_array(unsigned int num_data,
                                                                       unsigned int num_input,
                                                                       fann_type *input,
                                                                       unsigned int num_output,
                                                                       fann_type *output);
...
/* Function: fann_get_train_input
   ...
   This function appears in FANN >= 2.3.0
 */
FANN_EXTERNAL fann_type *FANN_API fann_get_train_input(struct fann_train_data *data,
...
/* Function: fann_get_train_output
   ...
   This function appears in FANN >= 2.3.0
 */
FANN_EXTERNAL fann_type *FANN_API fann_get_train_output(struct fann_train_data *data,
                                                        unsigned int position);
...
/* Function: fann_set_input_scaling_params
   ...
   See also:
    ...
    This function appears in FANN >= 2.1.0
 */
FANN_EXTERNAL int FANN_API fann_set_input_scaling_params(struct fann *ann,
...
/* Function: fann_set_output_scaling_params
   ...
   See also:
    ...
    This function appears in FANN >= 2.1.0
 */
FANN_EXTERNAL int FANN_API fann_set_output_scaling_params(struct fann *ann,
                                                          const struct fann_train_data *data,
...
/* Function: fann_set_scaling_params
   ...
   See also:
    ...
    This function appears in FANN >= 2.1.0
 */
FANN_EXTERNAL int FANN_API fann_set_scaling_params(struct fann *ann,
                                                   const struct fann_train_data *data,
                                                   float new_input_min, float new_input_max,
                                                   float new_output_min, float new_output_max);
...
/* Function: fann_subset_train_data
   ...
   This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL struct fann_train_data *FANN_API fann_subset_train_data(struct fann_train_data *data,
                                                                      unsigned int pos,
                                                                      unsigned int length);
...
/* Function: fann_save_train_to_fixed
   ...
   This function appears in FANN >= 1.0.0.
 */
FANN_EXTERNAL int FANN_API fann_save_train_to_fixed(struct fann_train_data *data,
                                                    const char *filename,
...
fann_set_train_error_function(struct fann *ann, enum fann_errorfunc_enum train_error_function);
 ...
 */
FANN_EXTERNAL void FANN_API
fann_set_train_stop_function(struct fann *ann, enum fann_stopfunc_enum train_stop_function);
...
/* Function: fann_get_rprop_decrease_factor
   ...
   The decrease factor is a value smaller than 1, which is used to decrease the step-size during
   RPROP training.
...
/* Function: fann_get_rprop_delta_min
   ...
   The minimum step-size is a small positive number determining how small the minimum step-size may
   be.
...
/* Method: fann_set_sarprop_weight_decay_shift
   ...
   */
FANN_EXTERNAL void FANN_API fann_set_sarprop_weight_decay_shift(struct fann *ann,
...
FANN_EXTERNAL void FANN_API fann_set_sarprop_step_error_threshold_factor(
    struct fann *ann, float sarprop_step_error_threshold_factor);
...
/* Method: fann_set_sarprop_step_error_shift
   ...
   */
FANN_EXTERNAL void FANN_API fann_set_sarprop_step_error_shift(struct fann *ann,
...
/* Method: fann_set_sarprop_temperature
   ...
   */
FANN_EXTERNAL void FANN_API fann_set_sarprop_temperature(struct fann *ann,
